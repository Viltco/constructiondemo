...
class JobCostLine(models.Model): 
    ...
    # @api.depends('customer_invoice_line_ids','customer_invoice_line_ids.quantity','customer_invoice_line_ids.price_unit','customer_invoice_line_ids.invoice_id.state')
    @api.depends('customer_invoice_line_ids','customer_invoice_line_ids.quantity','customer_invoice_line_ids.price_unit')
